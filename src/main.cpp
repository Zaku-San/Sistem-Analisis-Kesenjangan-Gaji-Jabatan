...
int main() {
    ...
    while (true) {
        ...
        cout << GREEN << BOLD << "\nSELAMAT DATANG DI APLIKASI SEMA \n" << RESET << YELLOW <<  "[Salary Equity Monitoring Application]. \n\n"<< RESET;
        cout << "Aplikasi Sistem Monitoring Keadilan Penggajian digunakan untuk\n"
        ...
        cout << "- Mengidentifikasi ketimpangan gaji antar karyawan dengan jabatan,\n"
                ...
                "- Menganalisis struktur penggajian berdasarkan tingkat pendidikan\n"
                "  gender, dan standar gaji industri\n"
